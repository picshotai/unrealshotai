...
const images = [
  { src: "/landing/landingphoto1.jpg", alt: "Professional Headshots: Close-up professional headshot with neutral background | Unrealshot AI" },
  { src: "/landing/landingphoto2.jpg", alt: "Professional Headshots: Business portrait in studio lighting | Unrealshot AI" },
  { src: "/landing/landingphoto3.jpg", alt: "Professional Headshots: Smiling headshot in formal attire | Unrealshot AI" },
  { src: "/landing/landingphoto4.jpg", alt: "Professional Headshots: Natural light portrait with soft background blur | Unrealshot AI" },
  { src: "/landing/landingphoto5.jpg", alt: "Professional Headshots: Confident pose, business casual look | Unrealshot AI" },
  { src: "/landing/landingphoto6.jpg", alt: "Professional Headshots: Profile angle with warm lighting | Unrealshot AI" },
  { src: "/landing/landingphoto7.jpg", alt: "Professional Headshots: Minimalist background, sharp focus | Unrealshot AI" },
  { src: "/landing/landingphoto9.jpg", alt: "Professional Headshots: Office setting headshot, polished look | Unrealshot AI" },
  { src: "/landing/landingphoto10.jpg", alt: "Professional Headshots: High-contrast portrait, strong presence | Unrealshot AI" },
  { src: "/landing/landingphoto11.jpg", alt: "Professional Headshots: Soft-focus headshot for approachable style | Unrealshot AI" },
  { src: "/landing/landingphoto12.jpg", alt: "Professional Headshots: Close-up professional headshot with neutral background | Unrealshot AI" },
  { src: "/landing/landingphoto13.jpg", alt: "Professional Headshots: Business portrait in studio lighting | Unrealshot AI" },
  { src: "/landing/landingphoto14.jpg", alt: "Professional Headshots: Smiling headshot in formal attire | Unrealshot AI" },
  { src: "/landing/landingphoto15.jpg", alt: "Professional Headshots: Natural light portrait with soft background blur | Unrealshot AI" },
  { src: "/landing/landingphoto16.jpg", alt: "Professional Headshots: Confident pose, business casual look | Unrealshot AI" },
   { src: "/landing/landingphoto8.jpg", alt: "Professional Headshots: Profile angle with warm lighting | Unrealshot AI" },
 { src: "/landing/landingphoto17.jpg", alt: "Professional Headshots: Minimalist background, sharp focus | Unrealshot AI" },
  { src: "/landing/landingphoto18.jpg", alt: "Professional Headshots: Office setting headshot, polished look | Unrealshot AI" },
  { src: "/landing/landingphoto19.jpg", alt: "Professional Headshots: High-contrast portrait, strong presence | Unrealshot AI" },
]
