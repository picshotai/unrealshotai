...
const images = [
  { src: "/landing/landingphoto1.jpg", alt: "AI Real Estate Headshots: Close-up professional headshot with neutral background | Unrealshot AI" },
  { src: "/landing/landingphoto2.jpg", alt: "AI Real Estate Headshots: Business portrait in studio lighting | Unrealshot AI" },
  { src: "/landing/landingphoto3.jpg", alt: "AI Real Estate Headshots: Smiling headshot in formal attire | Unrealshot AI" },
  { src: "/landing/landingphoto4.jpg", alt: "AI Real Estate Headshots: Natural light portrait with soft background blur | Unrealshot AI" },
  { src: "/landing/landingphoto5.jpg", alt: "AI Real Estate Headshots: Confident pose, business casual look | Unrealshot AI" },
  { src: "/landing/landingphoto6.jpg", alt: "AI Real Estate Headshots: Profile angle with warm lighting | Unrealshot AI" },
  { src: "/landing/landingphoto7.jpg", alt: "AI Real Estate Headshots: Minimalist background, sharp focus | Unrealshot AI" },
  { src: "/landing/landingphoto9.jpg", alt: "AI Real Estate Headshots: Office setting headshot, polished look | Unrealshot AI" },
  { src: "/landing/landingphoto10.jpg", alt: "AI Real Estate Headshots: High-contrast portrait, strong presence | Unrealshot AI" },
  { src: "/landing/landingphoto11.jpg", alt: "AI Real Estate Headshots: Soft-focus headshot for approachable style | Unrealshot AI" },
  { src: "/landing/landingphoto12.jpg", alt: "AI Real Estate Headshots: Close-up professional headshot with neutral background | Unrealshot AI" },
  { src: "/landing/landingphoto13.jpg", alt: "AI Real Estate Headshots: Business portrait in studio lighting | Unrealshot AI" },
  { src: "/landing/landingphoto14.jpg", alt: "AI Real Estate Headshots: Smiling headshot in formal attire | Unrealshot AI" },
  { src: "/landing/landingphoto15.jpg", alt: "AI Real Estate Headshots: Natural light portrait with soft background blur | Unrealshot AI" },
  { src: "/landing/landingphoto16.jpg", alt: "AI Real Estate Headshots: Confident pose, business casual look | Unrealshot AI" },
   { src: "/landing/landingphoto8.jpg", alt: "AI Real Estate Headshots: Profile angle with warm lighting | Unrealshot AI" },
 { src: "/landing/landingphoto17.jpg", alt: "AI Real Estate Headshots: Minimalist background, sharp focus | Unrealshot AI" },
  { src: "/landing/landingphoto18.jpg", alt: "AI Real Estate Headshots: Office setting headshot, polished look | Unrealshot AI" },
  { src: "/landing/landingphoto19.jpg", alt: "AI Real Estate Headshots: High-contrast portrait, strong presence | Unrealshot AI" },
]
