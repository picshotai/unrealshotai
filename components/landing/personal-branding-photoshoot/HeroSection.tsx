...
const images = [
  { src: "/landing/landingphoto1.jpg", alt: "Personal Branding Photoshoot: Creative portrait with styled outfit | Unrealshot AI" },
  { src: "/landing/landingphoto2.jpg", alt: "Personal Branding Photoshoot: Glamour look with soft studio lighting | Unrealshot AI" },
  { src: "/landing/landingphoto3.jpg", alt: "Personal Branding Photoshoot: Editorial pose with dramatic shadows | Unrealshot AI" },
  { src: "/landing/landingphoto4.jpg", alt: "Personal Branding Photoshoot: Outdoor scene with natural light | Unrealshot AI" },
  { src: "/landing/landingphoto5.jpg", alt: "Personal Branding Photoshoot: Fashion-inspired portrait, bold colors | Unrealshot AI" },
  { src: "/landing/landingphoto6.jpg", alt: "Personal Branding Photoshoot: Classic look against textured backdrop | Unrealshot AI" },
  { src: "/landing/landingphoto7.jpg", alt: "Personal Branding Photoshoot: Candid pose, lifestyle feel | Unrealshot AI" },
  { src: "/landing/landingphoto9.jpg", alt: "Personal Branding Photoshoot: Minimalist studio setup, clean lines | Unrealshot AI" },
  { src: "/landing/landingphoto10.jpg", alt: "Personal Branding Photoshoot: Artistic composition with unique framing | Unrealshot AI" },
  { src: "/landing/landingphoto11.jpg", alt: "Personal Branding Photoshoot: Vintage-inspired portrait aesthetics | Unrealshot AI" },
  { src: "/landing/landingphoto12.jpg", alt: "Personal Branding Photoshoot: Creative portrait with styled outfit | Unrealshot AI" },
  { src: "/landing/landingphoto13.jpg", alt: "Personal Branding Photoshoot: Glamour look with soft studio lighting | Unrealshot AI" },
  { src: "/landing/landingphoto14.jpg", alt: "Personal Branding Photoshoot: Editorial pose with dramatic shadows | Unrealshot AI" },
  { src: "/landing/landingphoto15.jpg", alt: "Personal Branding Photoshoot: Outdoor scene with natural light | Unrealshot AI" },
  { src: "/landing/landingphoto16.jpg", alt: "Personal Branding Photoshoot: Fashion-inspired portrait, bold colors | Unrealshot AI" },
   { src: "/landing/landingphoto8.jpg", alt: "Personal Branding Photoshoot: Classic look against textured backdrop | Unrealshot AI" },
 { src: "/landing/landingphoto17.jpg", alt: "Personal Branding Photoshoot: Candid pose, lifestyle feel | Unrealshot AI" },
  { src: "/landing/landingphoto18.jpg", alt: "Personal Branding Photoshoot: Minimalist studio setup, clean lines | Unrealshot AI" },
  { src: "/landing/landingphoto19.jpg", alt: "Personal Branding Photoshoot: Artistic composition with unique framing | Unrealshot AI" },
]
