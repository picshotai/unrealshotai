...
const images = [
  { src: '/landing/landingphoto1.jpg', alt: 'Resume Headshots: Close-up professional headshot with neutral background | Unrealshot AI' },
  { src: '/landing/landingphoto12.jpg', alt: 'Resume Headshots: Business portrait in studio lighting | Unrealshot AI' },
  { src: '/landing/landingphoto11.jpg', alt: 'Resume Headshots: Smiling headshot in formal attire | Unrealshot AI' },
  { src: '/landing/landingphoto15.jpg', alt: 'Resume Headshots: Natural light portrait with soft background blur | Unrealshot AI' },
  { src: '/landing/landingphoto16.jpg', alt: 'Resume Headshots: Confident pose, business casual look | Unrealshot AI' },
]
            ...
            {[...images, ...images].map((image, index) => (
              <div key={index} className="min-w-[200px] p-2 relative flex-shrink-0" style={{ padding: '0 10px' }}>
                <div className="relative w-[200px] h-[280px]">
                  ...
                  <div className="absolute bottom-2 left-2 flex items-center gap-[1.5px]"><Image src="/site-logo.png" alt="Unrealshot AI Logo" width={24} height={24} className="w-6 h-6 rounded" /></div>
                </div>
              </div>
            ))}
          </div>
            ...
            {images.map((image, index) => (
              <div key={`first-${index}`} className="w-[200px] p-2 relative flex-shrink-0">
                <div className="relative w-full h-full max-w-[200px] mx-auto aspect-[3/4]">
                  ...
                  <div className="absolute bottom-2 right-2 flex items-center gap-[1px] bg-white/80 rounded text-[10px]"><Image src="/site-logo.png" alt="Unrealshot AI Logo" width={16} height={16} className="w-4 h-4 rounded" /><span className="px-1 py-0.5">AI</span></div>
                </div>
              </div>
            ))}
            {images.map((image, index) => (
