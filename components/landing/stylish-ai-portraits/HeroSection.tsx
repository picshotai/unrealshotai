...
const images = [
  { src: "/landing/landingphoto1.jpg", alt: "Stylish AI Portraits: Modern portrait with soft lighting | Unrealshot AI" },
  { src: "/landing/landingphoto2.jpg", alt: "Stylish AI Portraits: Casual pose, lifestyle background | Unrealshot AI" },
  { src: "/landing/landingphoto3.jpg", alt: "Stylish AI Portraits: Professional yet relaxed expression | Unrealshot AI" },
  { src: "/landing/landingphoto4.jpg", alt: "Stylish AI Portraits: Color-pop styling with clean backdrop | Unrealshot AI" },
  { src: "/landing/landingphoto5.jpg", alt: "Stylish AI Portraits: Friendly smile, approachable tone | Unrealshot AI" },
  { src: "/landing/landingphoto6.jpg", alt: "Stylish AI Portraits: Editorial framing with dynamic angles | Unrealshot AI" },
  { src: "/landing/landingphoto7.jpg", alt: "Stylish AI Portraits: Muted tones, minimalist look | Unrealshot AI" },
  { src: "/landing/landingphoto9.jpg", alt: "Stylish AI Portraits: Warm light, natural ambiance | Unrealshot AI" },
  { src: "/landing/landingphoto10.jpg", alt: "Stylish AI Portraits: Bold contrast, standout presence | Unrealshot AI" },
  { src: "/landing/landingphoto11.jpg", alt: "Stylish AI Portraits: Creative crop, compelling composition | Unrealshot AI" },
  { src: "/landing/landingphoto12.jpg", alt: "Stylish AI Portraits: Modern portrait with soft lighting | Unrealshot AI" },
  { src: "/landing/landingphoto13.jpg", alt: "Stylish AI Portraits: Casual pose, lifestyle background | Unrealshot AI" },
  { src: "/landing/landingphoto14.jpg", alt: "Stylish AI Portraits: Professional yet relaxed expression | Unrealshot AI" },
  { src: "/landing/landingphoto15.jpg", alt: "Stylish AI Portraits: Color-pop styling with clean backdrop | Unrealshot AI" },
  { src: "/landing/landingphoto16.jpg", alt: "Stylish AI Portraits: Friendly smile, approachable tone | Unrealshot AI" },
   { src: "/landing/landingphoto8.jpg", alt: "Stylish AI Portraits: Editorial framing with dynamic angles | Unrealshot AI" },
 { src: "/landing/landingphoto17.jpg", alt: "Stylish AI Portraits: Muted tones, minimalist look | Unrealshot AI" },
  { src: "/landing/landingphoto18.jpg", alt: "Stylish AI Portraits: Warm light, natural ambiance | Unrealshot AI" },
  { src: "/landing/landingphoto19.jpg", alt: "Stylish AI Portraits: Bold contrast, standout presence | Unrealshot AI" },
]
