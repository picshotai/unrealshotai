...
const images = [
  { src: "/landing/landingphoto1.jpg", alt: "Natural Looks Photoshoot: Creative portrait with styled outfit | Unrealshot AI" },
  { src: "/landing/landingphoto2.jpg", alt: "Natural Looks Photoshoot: Glamour look with soft studio lighting | Unrealshot AI" },
  { src: "/landing/landingphoto3.jpg", alt: "Natural Looks Photoshoot: Editorial pose with dramatic shadows | Unrealshot AI" },
  { src: "/landing/landingphoto4.jpg", alt: "Natural Looks Photoshoot: Outdoor scene with natural light | Unrealshot AI" },
  { src: "/landing/landingphoto5.jpg", alt: "Natural Looks Photoshoot: Fashion-inspired portrait, bold colors | Unrealshot AI" },
  { src: "/landing/landingphoto6.jpg", alt: "Natural Looks Photoshoot: Classic look against textured backdrop | Unrealshot AI" },
  { src: "/landing/landingphoto7.jpg", alt: "Natural Looks Photoshoot: Candid pose, lifestyle feel | Unrealshot AI" },
  { src: "/landing/landingphoto9.jpg", alt: "Natural Looks Photoshoot: Minimalist studio setup, clean lines | Unrealshot AI" },
  { src: "/landing/landingphoto10.jpg", alt: "Natural Looks Photoshoot: Artistic composition with unique framing | Unrealshot AI" },
  { src: "/landing/landingphoto11.jpg", alt: "Natural Looks Photoshoot: Vintage-inspired portrait aesthetics | Unrealshot AI" },
  { src: "/landing/landingphoto12.jpg", alt: "Natural Looks Photoshoot: Creative portrait with styled outfit | Unrealshot AI" },
  { src: "/landing/landingphoto13.jpg", alt: "Natural Looks Photoshoot: Glamour look with soft studio lighting | Unrealshot AI" },
  { src: "/landing/landingphoto14.jpg", alt: "Natural Looks Photoshoot: Editorial pose with dramatic shadows | Unrealshot AI" },
  { src: "/landing/landingphoto15.jpg", alt: "Natural Looks Photoshoot: Outdoor scene with natural light | Unrealshot AI" },
  { src: "/landing/landingphoto16.jpg", alt: "Natural Looks Photoshoot: Fashion-inspired portrait, bold colors | Unrealshot AI" },
   { src: "/landing/landingphoto8.jpg", alt: "Natural Looks Photoshoot: Classic look against textured backdrop | Unrealshot AI" },
 { src: "/landing/landingphoto17.jpg", alt: "Natural Looks Photoshoot: Candid pose, lifestyle feel | Unrealshot AI" },
  { src: "/landing/landingphoto18.jpg", alt: "Natural Looks Photoshoot: Minimalist studio setup, clean lines | Unrealshot AI" },
  { src: "/landing/landingphoto19.jpg", alt: "Natural Looks Photoshoot: Artistic composition with unique framing | Unrealshot AI" },
]
