...
const images = [
  { src: "/landing/landingphoto1.jpg", alt: "Denim Wear Photoshoot: Creative portrait with styled outfit | Unrealshot AI" },
  { src: "/landing/landingphoto2.jpg", alt: "Denim Wear Photoshoot: Glamour look with soft studio lighting | Unrealshot AI" },
  { src: "/landing/landingphoto3.jpg", alt: "Denim Wear Photoshoot: Editorial pose with dramatic shadows | Unrealshot AI" },
  { src: "/landing/landingphoto4.jpg", alt: "Denim Wear Photoshoot: Outdoor scene with natural light | Unrealshot AI" },
  { src: "/landing/landingphoto5.jpg", alt: "Denim Wear Photoshoot: Fashion-inspired portrait, bold colors | Unrealshot AI" },
  { src: "/landing/landingphoto6.jpg", alt: "Denim Wear Photoshoot: Classic look against textured backdrop | Unrealshot AI" },
  { src: "/landing/landingphoto7.jpg", alt: "Denim Wear Photoshoot: Candid pose, lifestyle feel | Unrealshot AI" },
  { src: "/landing/landingphoto9.jpg", alt: "Denim Wear Photoshoot: Minimalist studio setup, clean lines | Unrealshot AI" },
  { src: "/landing/landingphoto10.jpg", alt: "Denim Wear Photoshoot: Artistic composition with unique framing | Unrealshot AI" },
  { src: "/landing/landingphoto11.jpg", alt: "Denim Wear Photoshoot: Vintage-inspired portrait aesthetics | Unrealshot AI" },
  { src: "/landing/landingphoto12.jpg", alt: "Denim Wear Photoshoot: Creative portrait with styled outfit | Unrealshot AI" },
  { src: "/landing/landingphoto13.jpg", alt: "Denim Wear Photoshoot: Glamour look with soft studio lighting | Unrealshot AI" },
  { src: "/landing/landingphoto14.jpg", alt: "Denim Wear Photoshoot: Editorial pose with dramatic shadows | Unrealshot AI" },
  { src: "/landing/landingphoto15.jpg", alt: "Denim Wear Photoshoot: Outdoor scene with natural light | Unrealshot AI" },
  { src: "/landing/landingphoto16.jpg", alt: "Denim Wear Photoshoot: Fashion-inspired portrait, bold colors | Unrealshot AI" },
   { src: "/landing/landingphoto8.jpg", alt: "Denim Wear Photoshoot: Classic look against textured backdrop | Unrealshot AI" },
 { src: "/landing/landingphoto17.jpg", alt: "Denim Wear Photoshoot: Candid pose, lifestyle feel | Unrealshot AI" },
  { src: "/landing/landingphoto18.jpg", alt: "Denim Wear Photoshoot: Minimalist studio setup, clean lines | Unrealshot AI" },
  { src: "/landing/landingphoto19.jpg", alt: "Denim Wear Photoshoot: Artistic composition with unique framing | Unrealshot AI" },
]
