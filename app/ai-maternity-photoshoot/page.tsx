...
import { HeroSection } from '@/components/landing/ai-maternity-photoshoot/HeroSection'
...
export const metadata: Metadata = commonPageMetadata.landingPage('ai-maternity-photoshoot')
...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <StructuredData data={JSON.parse(generateLandingPageWebApplicationJsonLd('ai-maternity-photoshoot'))} />
    </div>
  )
}