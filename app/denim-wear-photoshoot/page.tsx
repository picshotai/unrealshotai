...
import { HeroSection } from '@/components/landing/denim-wear-photoshoot/HeroSection'
...
export const metadata: Metadata = commonPageMetadata.landingPage('denim-wear-photoshoot')
...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <StructuredData data={JSON.parse(generateLandingPageWebApplicationJsonLd('denim-wear-photoshoot'))} />
    </div>
  )
}