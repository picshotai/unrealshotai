...
import { HeroSection } from '@/components/landing/office-outfit-photoshoot/HeroSection'
...
export const metadata: Metadata = commonPageMetadata.landingPage('office-outfit-photoshoot')
...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <StructuredData data={JSON.parse(generateLandingPageWebApplicationJsonLd('office-outfit-photoshoot'))} />
    </div>
  )
}