...
import { HeroSection } from '@/components/landing/ai-glamour-photoshoot/HeroSection'
...
export const metadata: Metadata = commonPageMetadata.landingPage('ai-glamour-photoshoot')
...
export default function AIGlamourPhotoshootPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <StructuredData data={JSON.parse(generateLandingPageWebApplicationJsonLd('ai-glamour-photoshoot'))} />
    </div>
  )
}