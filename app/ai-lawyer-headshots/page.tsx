...
import { HeroSection } from '@/components/landing/lawyer-headshots/HeroSection'
...
export const metadata: Metadata = commonPageMetadata.landingPage('lawyer-headshots')
...
export default function AIGlamourPhotoshootPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <StructuredData data={JSON.parse(generateLandingPageWebApplicationJsonLd('lawyer-headshots'))} />
    </div>
  )
}