...
import { HeroSection } from '@/components/landing/neutral-muse-photoshoot/HeroSection'
...
export const metadata: Metadata = commonPageMetadata.landingPage('neutral-muse-photoshoot')
...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <StructuredData data={JSON.parse(generateLandingPageWebApplicationJsonLd('neutral-muse-photoshoot'))} />
    </div>
  )
}