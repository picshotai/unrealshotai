...
import { HeroSection } from '@/components/landing/black-swan-photoshoot/HeroSection'
...
export const metadata: Metadata = commonPageMetadata.landingPage('black-swan-photoshoot')
...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <StructuredData data={JSON.parse(generateLandingPageWebApplicationJsonLd('black-swan-photoshoot'))} />
    </div>
  )
}