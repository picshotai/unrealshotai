...
import { HeroSection } from '@/components/landing/professional-headshots/HeroSection'
...
export const metadata: Metadata = commonPageMetadata.landingPage('professional-headshots')
...
export default function AIGlamourPhotoshootPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <StructuredData data={JSON.parse(generateLandingPageWebApplicationJsonLd('professional-headshots'))} />
    </div>
  )
}