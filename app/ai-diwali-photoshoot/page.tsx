...
import { HeroSection } from '@/components/landing/ai-diwali-photoshoot/HeroSection'
...
export const metadata: Metadata = commonPageMetadata.landingPage('ai-diwali-photoshoot')
...
export default function AIGlamourPhotoshootPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <StructuredData data={JSON.parse(generateLandingPageWebApplicationJsonLd('ai-diwali-photoshoot'))} />
    </div>
  )
}