...
import { HeroSection } from '@/components/landing/ai-christmas-photoshoot/HeroSection'
...
export const metadata: Metadata = commonPageMetadata.landingPage('ai-christmas-photoshoot')
...
export default function AIGlamourPhotoshootPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <StructuredData data={JSON.parse(generateLandingPageWebApplicationJsonLd('ai-christmas-photoshoot'))} />
    </div>
  )
}