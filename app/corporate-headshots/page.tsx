...
import { HeroSection } from '@/components/landing/corporate-headshots/HeroSection'
...
export const metadata: Metadata = commonPageMetadata.landingPage('corporate-headshots')
...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <StructuredData data={JSON.parse(generateLandingPageWebApplicationJsonLd('corporate-headshots'))} />
    </div>
  )
}