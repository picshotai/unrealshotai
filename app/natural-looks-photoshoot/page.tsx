...
import { HeroSection } from '@/components/landing/natural-looks-photoshoot/HeroSection'
...
export const metadata: Metadata = commonPageMetadata.landingPage('natural-looks-photoshoot')
...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <StructuredData data={JSON.parse(generateLandingPageWebApplicationJsonLd('natural-looks-photoshoot'))} />
    </div>
  )
}