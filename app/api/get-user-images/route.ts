...
export async function GET(request: Request) {
  ...
  console.log("Starting get-user-images request, since:", since);
  ...
  try {
    ...
    console.log("Prompts fetched:", promptsData.length, "items");
    ...
    console.log("Fetching images for user:", user.id, "with join on models");
    ...
    console.log("Images fetched:", imagesData.length, "items");
    ...
    console.log("Mapped prompts:", promptsImages.length, "items");
    ...
    console.log("Mapped images:", imagesImages.length, "items");

    // Combine and sort
    const combinedImages = [...promptsImages, ...imagesImages].sort(
      (a, b) => new Date(b.created_at).getTime() - new Date(a.created_at).getTime()
    );
    console.log("Combined images:", combinedImages.length, "items");
