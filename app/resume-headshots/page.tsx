...
import { HeroSection } from '@/components/landing/resume-headshots/HeroSection'
...
export const metadata: Metadata = commonPageMetadata.landingPage('resume-headshots')
...
export default function ResumeHeadshotsPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <Footer />
      <StructuredData data={JSON.parse(generateLandingPageWebApplicationJsonLd('resume-headshots'))} />
    </div>
  )
}